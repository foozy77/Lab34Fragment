...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            FragmentManager fragmentManager = getSupportFragmentManager(); //choose v4 to support older version
            // 2. Create Fragment Transaction
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            // 3. Create an instance of a fragment
            ImportFragment fragment = new ImportFragment(); //change according to class name
            ...
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            // 3. Create an instance of a fragment
            GalleryFragment fragment = new GalleryFragment(); //change according to class name
            // 4. Perform fragment transaction
            fragmentTransaction.replace(R.id.fragment_container, fragment);
            // 5. Commit transaction
            fragmentTransaction.commit();
